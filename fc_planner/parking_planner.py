...
def main():
    ...
    plt.plot(parking_planner.x_tan, parking_planner.y_tan, "ko")
    plt.plot(parking_planner.x_mid, parking_planner.y_mid, "ko")
    plt.plot(parking_planner.x_turn, parking_planner.y_turn, "ko")
    plt.plot(parking_planner.r1_center[0], parking_planner.r1_center[1], "ko")
    plt.plot(parking_planner.r2_center[0], parking_planner.r2_center[1], "ko")
    plt.plot(parking_planner.r1_x, parking_planner.r1_y, "k-")
    plt.plot(parking_planner.r2_x, parking_planner.r2_y, "k-")
